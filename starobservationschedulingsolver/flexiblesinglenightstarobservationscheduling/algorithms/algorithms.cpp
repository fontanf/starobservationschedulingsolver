#include "starobservationschedulingsolver/flexiblesinglenightstarobservationscheduling/algorithms/algorithms.hpp"
...
Output starobservationschedulingsolver::flexiblesinglenightstarobservationscheduling::run(
