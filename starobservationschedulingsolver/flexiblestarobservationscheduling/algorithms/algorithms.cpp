#include "starobservationschedulingsolver/flexiblestarobservationscheduling/algorithms/algorithms.hpp"
...
Output starobservationschedulingsolver::flexiblestarobservationscheduling::run(
