#include "starobservationschedulingsolver/starobservationscheduling/algorithms/algorithms.hpp"
...
Output starobservationschedulingsolver::starobservationscheduling::run(
        ...
        optimizationtools::Info info)
{
    ...
    } else if (algorithm_args[0] == "benders-decomposition") {
