#include "starobservationschedulingsolver/singlenightstarobservationscheduling/algorithms/algorithms.hpp"
...
Output starobservationschedulingsolver::singlenightstarobservationscheduling::run(
