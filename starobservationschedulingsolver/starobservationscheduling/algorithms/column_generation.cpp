...
{
    NightId night_id;
    starobservationschedulingsolver::singlenightstarobservationscheduling::Solution snsosp_solution;
    ...
    for (NightId night_id = 0;
        ...
        for (ObservableId observable_id = 0;
            ...
            if (fixed_targets_[observable.target_id] == 1)
                continue;
            starobservationschedulingsolver::singlenightstarobservationscheduling::Profit profit
                = (starobservationschedulingsolver::singlenightstarobservationscheduling::Profit)instance_.profit(observable.target_id)
