...
/**
 * Solution class for a 'flexiblesinglenightstarobservationschedulingsolver' problem.
 */
class Solution
{
...
/**
 * Output structure for a 'flexiblesinglenightstarobservationscheduling' problem.
 */
struct Output
{
    /** Constructor. */
