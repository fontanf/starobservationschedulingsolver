#include "flexiblestarobservationschedulingsolver/utils.hpp"

using namespace flexiblestarobservationschedulingsolver;

Instance flexiblestarobservationschedulingsolver::sosp2fsosp(
        const starobservationschedulingsolver::Instance& sosp_instance,
