#include "flexiblesinglenightstarobservationschedulingsolver/instance.hpp"
...
void flexiblesinglenightstarobservationschedulingsolver::init_display(
        const Instance& instance,
        optimizationtools::Info& info)
{
    info.os()
        << "============================================================" << std::endl
        << "  Flexible single-night star observation scheduling solver  " << std::endl
        << "============================================================" << std::endl
        << std::endl
        << "Instance" << std::endl
        << "--------" << std::endl;
