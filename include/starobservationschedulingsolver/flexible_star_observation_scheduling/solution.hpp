...
/**
 * Solution class for a 'flexible_star_observation_scheduling' problem.
 */
class Solution
{
...
public:
    ...
    inline TargetId number_of_observations() const { return number_of_observations_; }

    /** Get a night. */
    inline const SolutionNight& night(NightId night_id) const { return nights_[night_id]; }
...
/**
 * Output structure for a 'flexible_star_observation_scheduling' problem.
 */
